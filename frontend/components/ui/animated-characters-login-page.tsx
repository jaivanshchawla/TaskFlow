...
export function AnimatedAuthShell({ children, mode }: AnimatedAuthShellProps) {
  ...
  const hasPasswordField = isSignUp || passwordVisible;

  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      {/* Left Content Section */}
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-violet-600/90 via-violet-600 to-violet-700/80 p-12 text-white">
      ...
      {/* Right Content Section — Clerk goes here */}
